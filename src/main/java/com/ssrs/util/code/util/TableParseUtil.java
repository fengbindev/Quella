...
import com.ssrs.util.code.domain.ClassInfo;
import com.ssrs.util.code.domain.FieldInfo;
...
public class TableParseUtil {
    ...
    public static ClassInfo processTableIntoClassInfo(String tableSql) throws IOException {
        ...
        // class Name
        String className = ToolUtil.upperFirst(StrUtil.toCamelCase(tableName));
        ...
        if (fieldLineList.length > 0) {
            ...
            for (String columnLine :fieldLineList) {
                ...
                if (!columnLine.contains("key ")&&!columnLine.contains("constraint")&&!columnLine.contains("using")&&!columnLine.contains("unique")
                    ...
                    // field Name
                    String fieldName = ToolUtil.lowerFirst(StrUtil.toCamelCase(columnName));
