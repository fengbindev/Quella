...
public class UpdateHtmlTemplate {
    ...
    private static String genHtmlBody(Generate generate) {
        ...
        String filePath = UpdateHtmlTemplate.class.getResource("").getPath()
                + UpdateHtmlTemplate.class.getSimpleName() + ".code";
    ...
    public static String generate(Generate generate) {
        String filePath = GenerateUtil.getHtmlFilePath(generate, "update");
        String content = UpdateHtmlTemplate.genHtmlBody(generate);
        try {
