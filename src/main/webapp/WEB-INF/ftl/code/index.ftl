                ...
                <table class="layui-table">
                    ...
                    <#--<tr>-->
                        ...
                        <#--<td class="layui-form entity-type">-->
                            <#--<select name="type"   lay-verify="entity-type"></select>-->
                        <#--</td>-->
                        <#--<td class="layui-form entity-query">-->
                            <#--<select name="query" mo-empty="" lay-verify="entity-type"></select>-->
                        <#--</td>-->
                        <#--<td class="layui-form entity-show">-->
                            <#--<input name="show" type="checkbox" lay-text="是|否" value="1" lay-skin="switch">-->
                        <#--</td>-->
                        <#--<td class="entity-verify">-->
                            <#--<select name="verify"></select>-->
                        <#--</td>-->
                    <#--</tr>-->
                    </tbody>
                </table>
